...
import { Paper, Text, Group, Stack, Badge, SimpleGrid, ActionIcon, Tooltip } from '@mantine/core'
      ...
      >
        <Group justify="space-between" wrap="nowrap" mb={4}>
          ...
          <Badge
            ...
            radius="sm"
          >
            {item.severity >= 7 ? 'Critical' : item.severity >= 4 ? 'Warning' : 'Info'}
          </Badge>
        </Group>
        <Group gap="xs" mb={4}>
        ...
        <Group justify="space-between" align="flex-end">
          <div>
            ...
            <Text size="xs" c="dimmed">
              ...
              Baselines use all data; recent periods compared against baseline.
            </Text>
          </div>
        </Group>
